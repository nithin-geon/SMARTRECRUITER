...
namespace SupportTicket.Business.Masters
{
    public class BlTickets:ITickets
    {
        ...
        private Int64 _FK_PositionRequest;
        ...
        public long FK_PositionRequest { get => _FK_PositionRequest; set => _FK_PositionRequest = value; }
        ...
        public DataTable FillResumes()
        {
            DataTable dtbl = new DataTable();
            DalTickets daltickets = new DalTickets();
            dtbl = daltickets.FillResumes(this);
            daltickets = null;
            return dtbl;
        }
        ...
        public long DeleteData()
        {
            ...
            try
            {
                status = DalTickets.DeleteTickets(this);
                DalTickets = null;
            }
            catch (Exception ex)
            {
