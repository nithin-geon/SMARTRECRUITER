    ...
    this.FillStatusDropdown = function () {
        try {
            $.ajax({
                ...
                url: api_url + '/Reports/StatusDropDownFill',
                cache: false,
                type: 'POST',
                dataType: 'json',
                        ...
                        if (Mydata.length > 0) {
                            ...
                            $.each(Mydata, function (key, val) {
                                html += "<tr>" +
                                            "<td style = 'display:none'>" + val.ID_Tickets + "</td>" +
                                            "<td>" + val.SlNo + "</td>" +
                                            "<td><a target='_blank' href='../Resumes/Resumes?ID_Resumes=" + val.ID_Tickets + "'>" + val.TickNo + "</a>" + "&nbsp&nbsp" +
                               ...
                               html += "</td>";
                                     html +=       "<td>" + val.TickDate + "</td>" +
                                         ...
                                         "<td>" + val.CandidateEmailId + "</td>" +
                                         "<td>" + val.CandidateMob + "</td>" +
